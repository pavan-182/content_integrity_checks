...
from ..thresholds import (
    ENTITY_NORMALIZED_TEMPLATE_LOCAL_MASKED_SIMILARITY_THRESHOLD as LOCAL_MASKED_SIMILARITY_THRESHOLD,
    ENTITY_NORMALIZED_TEMPLATE_LOCAL_ORIGINAL_SUPPORT_THRESHOLD as LOCAL_ORIGINAL_SUPPORT_THRESHOLD,
    ENTITY_NORMALIZED_TEMPLATE_LOCAL_SEQUENCE_SIMILARITY_THRESHOLD as LOCAL_SEQUENCE_SIMILARITY_THRESHOLD,
    ENTITY_NORMALIZED_TEMPLATE_MASKED_SIMILARITY_THRESHOLD as MASKED_SIMILARITY_THRESHOLD,
    ENTITY_NORMALIZED_TEMPLATE_MAXIMUM_PLACEHOLDER_RATIO as MAXIMUM_PLACEHOLDER_RATIO,
    ENTITY_NORMALIZED_TEMPLATE_MINIMUM_GLOBAL_ORIGINAL_FOR_LOCAL as MINIMUM_GLOBAL_ORIGINAL_FOR_LOCAL,
    ENTITY_NORMALIZED_TEMPLATE_MINIMUM_SKELETON_WORDS as MINIMUM_SKELETON_WORDS,
    ENTITY_NORMALIZED_TEMPLATE_MINIMUM_SUBSTITUTIONS as MINIMUM_SUBSTITUTIONS,
    ENTITY_NORMALIZED_TEMPLATE_MODERATE_GLOBAL_MASKED_THRESHOLD as MODERATE_GLOBAL_MASKED_THRESHOLD,
    ENTITY_NORMALIZED_TEMPLATE_MODERATE_LOCAL_MASKED_THRESHOLD as MODERATE_LOCAL_MASKED_THRESHOLD,
    ENTITY_NORMALIZED_TEMPLATE_MODERATE_LOCAL_ORIGINAL_THRESHOLD as MODERATE_LOCAL_ORIGINAL_THRESHOLD,
    ENTITY_NORMALIZED_TEMPLATE_MODERATE_SHARED_SKELETON_WORDS as MODERATE_SHARED_SKELETON_WORDS,
    ENTITY_NORMALIZED_TEMPLATE_ORIGINAL_SUPPORT_THRESHOLD as ORIGINAL_SUPPORT_THRESHOLD,
    ENTITY_NORMALIZED_TEMPLATE_RARE_TITLE_TOKEN_DOCUMENT_FREQUENCY as RARE_TITLE_TOKEN_DOCUMENT_FREQUENCY,
    ENTITY_NORMALIZED_TEMPLATE_SECTION_SIMILARITY_THRESHOLD as SECTION_SIMILARITY_THRESHOLD,
)
